...
public class PanelStructure extends JPanel implements ActionListener, MouseListener, KeyListener, ItemListener{
    ...
    public JScrollPane initialiserTableau(TableModel model){
        ...
        if (existeColonne(tableau, "Modifier")){
            ...
            tableau.getColumn("Modifier").setMinWidth(90);
            tableau.getColumn("Modifier").setMaxWidth(180);
        }
        
         if (existeColonne(tableau, "Prêter")){
            tableau.getColumn("Prêter").setCellRenderer(new ButtonRenderer());
            tableau.getColumn("Prêter").setCellEditor(new DeleteButtonEditor(tableau.getModel(),"Prêter",fenetre));
            tableau.getColumn("Prêter").setMinWidth(90);
            tableau.getColumn("Prêter").setMaxWidth(180);
        }
        
        if (existeColonne(tableau, "Adhérer")){
            tableau.getColumn("Adhérer").setCellRenderer(new ButtonRenderer());
            tableau.getColumn("Adhérer").setCellEditor(new DeleteButtonEditor(tableau.getModel(),"Adhérer",fenetre));
            tableau.getColumn("Adhérer").setMinWidth(100);
            tableau.getColumn("Adhérer").setMaxWidth(200);
        }
        ...
        if (existeColonne(tableau, "Supprimer")){
            ...
            tableau.getColumn("Supprimer").setMinWidth(100);
            tableau.getColumn("Supprimer").setMaxWidth(200);
        }
         ...
         if (existeColonne(tableau, "Confirmer")){
            ...
            tableau.getColumn("Confirmer").setMaxWidth(180);
        }
          ...
          if (existeColonne(tableau, "Action")){
            ...
            tableau.getColumn("Action").setMaxWidth(180);
        }
        if (existeColonne(tableau, "Titre du média")){
            tableau.getColumn("Titre du média").setMinWidth(450);
            tableau.getColumn("Titre du média").setMaxWidth(900);
        }
        if (existeColonne(tableau, "Auteur")){
            tableau.getColumn("Auteur").setMinWidth(200);
            tableau.getColumn("Auteur").setMaxWidth(900);
        }
    ...
    public void responsivePanel()
    {
        ...
        //Boutons et combos de pagination
    ...
    public void mousePressed(MouseEvent me) {
        if (me.getSource().equals(barreRecherche)){
          if (barreRecherche.getText().equalsIgnoreCase("Rechercher par titre")
             ||(barreRecherche.getText().equalsIgnoreCase("Rechercher par titre ou emprunteur"))
             ||(barreRecherche.getText().equalsIgnoreCase("Rechercher par nom ou prénom"))){
    ...
    public void keyReleased(KeyEvent ke) {
        ...
        if(ke.getKeyCode() == KeyEvent.VK_ENTER){
           ...
           if(this instanceof PanelAdherent){
              ((PanelAdherent)this).MAJTableau(false);
           }        
           
            if(this instanceof PanelSympathisant){
               ((PanelSympathisant)this).MAJTableau(false);
           }         
        } 
    }  
        ...
        if (e.getStateChange()==ItemEvent.SELECTED)
        {
           boolean comboPage=false;
            ...
            if(e.getSource().equals(combo4)){
              ...
              if(this instanceof PanelSympathisant)
               ((PanelSympathisant)this).MAJTableau(comboPage);
              
              if(this instanceof PanelAdherent)
               ((PanelAdherent)this).MAJTableau(comboPage);
